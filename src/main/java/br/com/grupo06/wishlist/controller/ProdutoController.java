...
public class ProdutoController {
    ...
    @ApiOperation(value = "Listar um produto informando o nome")
    @GetMapping("/produtos/nome/{nome}")
    public ResponseEntity buscarProdutoPeloNome(@PathVariable("nome") String nome){
        List<ProdutoEntity> produtos = this.produtoService.buscarProdutoPeloNome(nome);
        if(!produtos.isEmpty()){
