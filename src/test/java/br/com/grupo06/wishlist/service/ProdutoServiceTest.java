...
class ProdutoServiceTest {
    ...
    void listarPorNome() throws ExcecaoEsperada {
        ...
        produtoServiceTest.salvar(produto);
        //when
        List<ProdutoEntity> produtoEncontrado  = produtoServiceTest.buscarProdutoPeloNome(produto.getNome());
        // then
        assertThat(produtoEncontrado.get(0).getNome()).isEqualTo(produto.getNome());
    }
